...
/**
 * Provides the behavior that allows the toolbar to snap either fully up or fully down when the
 * user releases their finger after scrolling the recyclerview and the toolbar isn't fully visible.
 */
